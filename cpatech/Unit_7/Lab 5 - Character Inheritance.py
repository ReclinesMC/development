...
rogue = ch.Rogue("CoolRogue", r.randint(10, 15), r.randint(10, 20), r.randint(5, 15), r.randint(15, 25), r.randint(10, 15))
sorcerer = ch.Sorcerer("CoolSorcerer", r.randint(10, 15), r.randint(10, 20), r.randint(5, 15), r.randint(15, 25), r.randint(10, 15))
bard = ch.Bard("CoolBard", r.randint(10, 15), r.randint(10, 20), r.randint(5, 15), r.randint(15, 25), r.randint(10, 15))
wizard = ch.Wizard("CoolWizard", r.randint(10, 15), r.randint(10, 20), r.randint(5, 15), r.randint(15, 25), r.randint(10, 15))
